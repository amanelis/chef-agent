...
# Start: curl -L https://raw.github.com/amanelis/chef-agent/play/install_amzn1-production.sh | bash
...
$chef_binary -c $chef_directory/solo.rb -j $chef_directory/platform_amzn1-production.json
