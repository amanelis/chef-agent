...
# Start: 
# 	base: 	    curl -L https://raw.github.com/signifyd/chef-agent/play/install_amzn1.sh | bash -s base
# 	staging:    curl -L https://raw.github.com/signifyd/chef-agent/play/install_amzn1.sh | bash -s staging
# 	production: curl -L https://raw.github.com/signifyd/chef-agent/play/install_amzn1.sh | bash -s production
